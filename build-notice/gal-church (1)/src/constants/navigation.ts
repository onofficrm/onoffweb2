...
// Gnuboard 5 Notice Board URLs
export const GNUBOARD_BASE_URL = 'https://onoffweb2.iwinv.net';
export const GNUBOARD_NOTICE_LIST_URL = 'https://onoffweb2.iwinv.net/bbs/board.php?bo_table=notice';
export const GNUBOARD_NOTICE_WRITE_URL = 'https://onoffweb2.iwinv.net/bbs/write.php?bo_table=notice';
export const GNUBOARD_NOTICE_EDIT_URL = (wr_id: number | string) =>
  `https://onoffweb2.iwinv.net/bbs/write.php?w=u&bo_table=notice&wr_id=${wr_id}`;
export const GNUBOARD_NOTICE_VIEW_URL = (wr_id: number | string) =>
  `https://onoffweb2.iwinv.net/bbs/board.php?bo_table=notice&wr_id=${wr_id}`;
export const GNUBOARD_WRITE_UPDATE_URL = 'https://onoffweb2.iwinv.net/bbs/write_update.php';
...
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    label: '공지사항',
    subItems: [
      { id: 'notice-list', label: '글목록', pageId: 'notice', sectionId: 'list' },
      { id: 'notice-write', label: '글쓰기', pageId: 'notice', sectionId: 'write' },
      { id: 'notice-edit', label: '글수정', pageId: 'notice', sectionId: 'edit' },
    ],
  },
  {
    id: 'counseling',
