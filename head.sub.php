...
<meta charset="utf-8">
<?php
// 반응형: 모바일 전용 테마를 꺼도 viewport는 필수 (없으면 폰에서 PC 화면처럼 축소됨)
echo '<meta name="viewport" id="meta_viewport" content="width=device-width,initial-scale=1.0,minimum-scale=1.0,maximum-scale=5.0,viewport-fit=cover">'.PHP_EOL;
