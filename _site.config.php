...
$site_config = array(
    'site_name'           => 'GAL CHURCH',
    'site_desc'           => 'GAL교회는 온라인에서 만나고, 말씀으로 깨어나며, 사랑으로 세상에 나아가는 교회입니다.',
    'company_name'        => 'GAL CHURCH',
    'ceo_name'            => '이대희 목사',
    'business_no'         => '',
    'phone'               => '',
    'kakao_url'           => 'https://pf.kakao.com/_EkyrX/chat',
    'email'               => '',
    'address'             => '',
    ...
    'seo_description'     => 'GAL교회는 온라인에서 만나고, 말씀으로 깨어나며, 사랑으로 세상에 나아가는 교회입니다.',
    'main_keyword'        => 'GAL교회,온라인교회,이대희목사',
    'sub_keywords'        => '주일예배,온라인상담,다음세대',
    'robots'              => 'index,follow',
    'consultation_text'   => '카카오톡 상담',
    'footer_desc'         => '온라인에서 만나고, 말씀으로 깨어나고, 사랑으로 세상에 나아가는 교회. 전통적인 틀을 넘어 다음세대와 세상을 품는 건강한 신앙 공동체입니다.',
